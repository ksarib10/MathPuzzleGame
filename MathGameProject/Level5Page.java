...
public class Level5Page extends MainFile {

    final private String bBText = "<\t\t     LEVEL 5";
    final private String imgURL = "pics/level5Image.jpg";
    final private String hintURL = "pics/hint5.jpg";
    final private String level3Ans = "14";
    final private String level3Title = "Math Puzzle - Level 5";
    
    final private int nextLvlCount = 6;
