...
public class Level2Page extends MainFile {

    final private String bBText = "<\t\t     LEVEL 2";
    final private String imgURL = "pics/level2Image.jpg";
    final private String hintURL = "pics/hint2.jpg";
    final private String leve2Ans = "6";
    final private String level2Title = "Math Puzzle - Level 2";

    final private int nextLvlCount = 3;
...
*/
    ...
    hintButton, enterButton, filter, hintURL, leve2Ans, nextLvlCount);
    ...
    primaryStage.setTitle(level2Title);
