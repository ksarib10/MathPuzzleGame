...
public class Level6Page extends MainFile {

    final private String bBText = "<\t\t     LEVEL 6";
    final private String imgURL = "pics/level6Image.jpg";
    final private String hintURL = "pics/hint6.jpg";
    final private String level3Ans = "5";
    final private String level3Title = "Math Puzzle - Level 6";
    
    final private int nextLvlCount = 7;
