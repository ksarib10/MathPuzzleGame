...
public class Level1Page extends MainFile {

    final private String bBText = "<\t\t     LEVEL 1";
    final private String imgURL = "pics/level1Image.jpg";
    final private String hintURL = "pics/hint1.jpg";
    final private String level1Ans = "32";
    final private String level1Title = "Math Puzzle - Level 1";

    final private int nextLvlCount = 2;
...
// MAIN METHOD OF APPLICATION
    ...
    //Creating Back Button
        ...
        backButton.setOnAction(e -> {
            MathPuzzleLevelPage levelpage = new MathPuzzleLevelPage(); levelpage.start(primaryStage);});
...
/*  Setting up Grid 2 that includes answer text area, messageLabel, clear button,
    ...
    // Setting up Grid 2 of the Main Grid that includes Answer area and clear, hint and enter button
        setGrid2(primaryStage, grid2, textField, answerTextArea, clearButton, hintButton, enterButton,
         filter, hintURL, level1Ans, nextLvlCount);
        ...
        primaryStage.setTitle(level1Title);
