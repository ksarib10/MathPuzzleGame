...
public class Level4Page extends MainFile {

    final private String bBText = "<\t\t     LEVEL 4";
    final private String imgURL = "pics/level4Image.jpg";
    final private String hintURL = "pics/hint4.jpg";
    final private String level3Ans = "10";
    final private String level3Title = "Math Puzzle - Level 4";
    
    final private int nextLvlCount = 5;
